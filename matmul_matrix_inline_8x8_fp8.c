...
// DIM_M, DIM_K, DIM_N are now provided by data_8x8_fp8.h
...
#define MATMUL_MATRIX_LDC_ELEMS 8
#endif
...
#ifndef MATMUL_MATRIX_KERNEL_ONLY
int main() {
  /* Include data_8x8_fp8.h locally to ensure constants are available */
  #include "data_8x8_fp8.h"
